 ...
 * @copyright 2007-2011
  ...
  **/
	...
	abstract class WideImage_Image
	{
		 ...
		 *
		 * @param resource $handle Images handle (GD2 resource)
		 */
		 ...
		 * </code>
		 * 
		 * @param string $format Images format
		 */
		 ...
		 * @return WideImage_Image Images with corrected gamma
		 **/
		 ...
		 * @return WideImage_Image Images with noise added
		 **/
