 ...
 * @copyright 2007-2011
  ...
  **/
	...
	class WideImage_Canvas
	{
		 ...
		 *
		 * @param WideImage_Image $img Images object
		 */
		 ...
		 * Example:
		 * <code>
		 * $images = WideImage::load('pic.jpg');
		 * $canvas = $images->getCanvas();
		 * $canvas->useFont('Verdana.ttf', 16, $images->allocateColor(255, 0, 0));
		 ...
		 * $images = WideImage::load('pic.jpg');
		 * $canvas = $images->getCanvas();
		 * $canvas->filledRect(10, 10, 20, 30, $images->allocateColor(0, 0, 0));
		 * $canvas->line(60, 80, 30, 100, $images->allocateColor(255, 0, 0));
		 * </code>
		 */
