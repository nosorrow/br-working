...
class CF_Container
{
     ...
     *
     * # Enable Referrer
     * $public_container->acl_referrer("http://www.example.com/new_gallery.php");
     * </code>
     *
     * @returns boolean True if successful
     * @throws CDNNotEnabledException CDN functionality not returned during auth
...
class CF_Object
{
     ...
     *
     * # Print out the Object's CDN URI (if it has one) in an HTML images-tag
     * #
     * print "<images src='$pic->public_uri()' />\n";
     * </code>
     *
